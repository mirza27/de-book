    ...
    return (
        <div className="w-full h-fit bg-white py-10">
            <div className="max-w-5xl mx-auto pt-5 text-black">
                <form onSubmit={handleSubmit} className="bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded px-8 pt-6 pb-8 my-5">
                <h1 className="text-2xl font-bold mb-7">Create New Book</h1>
                    ...
                    <div className="mb-4">
                        <label htmlFor="yearRelease" className="block text-black font-bold mb-2">
                            Year Release
                        </label>
                        <input
                            type="number"
                    ...
                    <div className="mb-4">
                        ...
                        <input type="file" className="file-input file-input-bordered file-input-md w-full max-w-full bg-white border-black focus:outline-none focus:border-black" />
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-4">
                        <Link href={"/admin/dashboard"} className="btn btn-error btn-md text-white">Back</Link>
                        <button
                            type="submit"
